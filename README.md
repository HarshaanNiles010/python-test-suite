...
This project serves as a structured skill assessment and practice environment for Python developers. It covers 8 topics through 165 tasks and 308 automated tests, all using the Python standard library (no third-party packages beyond pytest).
...
| `advanced_task.py` | Advanced Python | 20 | 53 | Generators, decorators, context managers, closures, itertools, functools, descriptors, metaclasses |
...
python3 -m pytest tests/test_advanced_task.py -v
```
