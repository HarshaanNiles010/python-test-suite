...
This project serves as a structured skill assessment and practice environment for Python developers. It covers 8 core topics through 165 tasks and 349 automated tests, all using the Python standard library (no third-party packages beyond pytest).
...
| `sorting_task.py` | Sorting Algorithms | 20 | 94 | Bubble sort, insertion sort, merge sort, quick sort, optimizations, counting operations |
...
python -m pytest tests/test_sorting_task.py -v
```
